...
@SpringBootTest(classes = {MockServerConfig.class, WebClientTestConfig.class})
@WithMockUser
class BrokerServiceTest {
    ...
    void testFindHotelsByCity() {
        ...
        assertAll("success",
                        ...
                        () -> assertTrue(hotelsByCity.stream()
                                        .allMatch(brokerHotel -> brokerHotel.cityCode().equals(cityCode)))
        );
    }
    ...
    void testGetHotelDetails() {
        ...
        assertAll("success",
                        ...
                        () -> assertThat(hotelDetails.get().id(), is(hotelCode))
        );
    }
